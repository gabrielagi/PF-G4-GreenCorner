...
const Card = ({ name, images, price, id }) => {
 ...
 const loginAlert = () => {
  ...
  return (
    <div className=" font-poppins bg-slate-100 bg-opacity-60 rounded-md box-border md:h-85 md:w-80 p-4 shadow-lg relative flex flex-col justify-between transition transform hover:scale-110 items-center md">
