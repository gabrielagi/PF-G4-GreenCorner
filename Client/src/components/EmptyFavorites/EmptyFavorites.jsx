...
const EmptyFavorites = () => {
  ...
  return (
    <div className='mb-20 grid  text-center mx-auto'>
        ...
        <Link to="/shop">
            <button className="-mt-40 bg-green-500 text-white font-semibold py-4 px-8 rounded hover:bg-green-600 font-poppins flex mx-auto sm:text-4xl text-center sm:px-10 sm:w-[30%] sm:h-30">
              {`Visit our Shop `}
