  ...
  const sortedOrders = ordersWithIndex.slice().sort((a, b) => {
    ...
    switch (sortColumn) {
      ...
      case "shippingAddress":
        return (
          a.shippingAddress.localeCompare(b.shippingAddress) * compareValue
        );
      case "total":
          ...
          <thead>
            <tr>
              ...
              <th onClick={() => handleSort("shippingAddress")}>
                <div className={styles.divArrow}>
                  Shipping Address {getSortArrow("shippingAddress")}
                </div>
              </th>
          ...
          <tbody>
            {currentOrders.map((order) => (
              <tr key={order.id}>
                ...
                <td>{order.date}</td>
                <td>
                  <div className={getStatusCircleClassName(order.status)} />{" "}
                  {order.status}
                </td>
